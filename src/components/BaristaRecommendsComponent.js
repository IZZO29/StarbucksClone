                    ...
                    >
                        <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
                            <div className="grid grid-cols-[1fr_3fr]">
                                <div>
                                    <img src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/112595.webp"
                                        alt="Hazelnut Triangle"
                                ...
                                <div className="p-2">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M7.13397 4.5C7.51887 3.83333 8.48113 3.83333 8.86603 4.5L12.3301 10.5C12.715 11.1667 12.2339 12 11.4641 12H4.5359C3.7661 12 3.28497 11.1667 3.66987 10.5L7.13397 4.5Z" fill="#D62B1F" />
                                    </svg>
                                    <p className="font-semibold">Hazelnut Triangle</p>
                                    <p className="text-xs text-[#6c757d]">PER SERVE (50 g)  - 302 Kcal</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-5">
                                <div className="flex justify-between items-center">
                                    <div className="font-semibold text-sm">
                                        <span>₹ 204 <span className="text-xs">.75</span></span>
                                    </div>
                        ...
                        <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
                            <div className="grid grid-cols-[1fr_3fr]">
                                <div>
                                    <img src="	https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/112601.webp"
                                        alt="Bhuna Chicken Puff"
                                        className="rounded-lg h-20 object-cover"
                                        width={80}>
                                    </img>
                                </div>
                                <div className="p-2">
                                    ...
                                    <p className="font-semibold">Bhuna Chicken Puff</p>
                                    <p className="text-xs text-[#6c757d]">PER SERVE (85 g)  - 390 Kcal</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-5">
                                <div className="flex justify-between items-center">
                                    <div className="font-semibold text-sm">
                                        <span>₹ 194 <span className="text-xs">.25</span></span>
                                    </div>
                        ...
                        <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
                            <div className="grid grid-cols-[1fr_3fr]">
                                <div>
                                    <img src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/113008.webp"
                                        alt="Chocolate Brownie Cupcake"
                                        className="rounded-lg h-20 object-cover"
                                        width={80}>
                                    </img>
                                </div>
                                <div className="p-2">
                                    ...
                                    <p className="font-semibold">Chocolate Brownie Cupcake</p>
                                    <p className="text-xs text-[#6c757d]">PER SERVE (80 g)  - 416 Kcal</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-5">
                                <div className="flex justify-between items-center">
                                    <div className="font-semibold text-sm">
                                        <span>₹ 288 <span className="text-xs">.75</span></span>
                                    </div>
                        ...
                        <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
                            <div className="grid grid-cols-[1fr_3fr]">
                                <div>
                                    <img src="	https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/112737.webp"
                                        alt="Three Dip Nachos"
                                        className="rounded-lg h-20 object-cover"
                                        width={80}>
                                    </img>
                                </div>
                                <div className="p-2">
                                    ...
                                    <p className="font-semibold">Three Dip Nachos</p>
                                    <p className="text-xs text-[#6c757d]">PER SERVE (180 g)  - 513 Kcal</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-5">
                                <div className="flex justify-between items-center">
                                    <div className="font-semibold text-sm">
                                        <span>₹ 262 <span className="text-xs">.50</span></span>
                                    </div>
                        ...
                        <SwiperSlide><div className="w-30 h-auto bg-white rounded-lg shadow-sm p-4 cursor-pointer">
                            <div className="grid grid-cols-[1fr_3fr]">
                                <div>
                                    <img src="https://starbucks-cdn-01.s3.ap-south-1.amazonaws.com/Items/Large/webP/113001.webp"
                                        alt="Chilli Paneer In Herbed Bun"
                                        className="rounded-lg h-20 object-cover"
                                        width={80}>
                                    </img>
                                </div>
                                <div className="p-2">
                                    ...
                                    <p className="font-semibold">Chilli Paneer In Herbed Bun</p>
                                    <p className="text-xs text-[#6c757d]">PER SERVE (160 g)  - 598 Kcal</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-5">
                                <div className="flex justify-between items-center">
                                    <div className="font-semibold text-sm">
                                        <span>₹ 283 <span className="text-xs">.50</span></span>
                                    </div>
