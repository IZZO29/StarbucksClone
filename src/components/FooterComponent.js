        ...
        <>
            <div className="p-5 lg:pl-20 lg:pr-20 bg-[#0e382c] w-full">
                <div className="flex justify-between flex-wrap">
                    <div className="mt-2">
                        <img src={require("../images/logo.png")} alt="logo"></img></div>
                    ...
                    <div className='mt-2'>
                        <p className='mt-2 cursor-pointer'>
                            <img src="https://www.starbucks.in/assets/images/appstoreiOS.png" alt="ios store" />
                        </p>
                        <p className='mt-2 cursor-pointer'>
                            <img src="	https://www.starbucks.in/assets/images/appstoreAndroid.png" alt="android store" />
                        </p>
                    </div>
                </div>

                <hr className='mt-16'></hr>
                <div className='text-white text-sm mt-5 font-thin flex justify-between cursor-pointer'>
                    <div>
                        <span>
